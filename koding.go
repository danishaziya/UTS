...
func LihatInformasiPengguna() {
	...
	fmt.Println("Username             	: Ziya")
	fmt.Println("Password               : 2406447055")
	fmt.Println("Jenis Kelamin        	: Perempuan")
	fmt.Println("Makanan Favorit        : Gacoan")
	fmt.Println("Minuman Favorit		: Matcha")
	fmt.Println("==================================")
}
...
func main() {
	...
	var pengguna = Pengguna{"Ziya", "2406447055"}
